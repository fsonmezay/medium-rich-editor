...
(function (window, document) {
    ...
    MediumEditor.prototype = {
        defaults: {
            ...
            buttons: ['bold', 'italic', 'underline', 'strikethrough',  'anchor', 'header1', 'header2', 'header3', 'pre', 'quote', 'orderedlist', 'unorderedlist', 'indent', 'outdent', 'justifyLeft', 'justifyCenter', 'justifyFull', 'justifyRight'],
            buttonLabels: false,
        ...
        buttonTemplate: function (btnType) {
            var buttonLabels = this.getButtonLabels(this.options.buttonLabels),
                buttonTemplates = {
                    ...
                    'header5': '<button class="medium-editor-action medium-editor-action-header5" data-action="append-' + this.options.fifthHeader + '" data-element="' + this.options.fifthHeader + '">' + buttonLabels.header5 + '</button>',
